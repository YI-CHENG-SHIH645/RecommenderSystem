...
private:
    static IDX_SCORE_VEC calculate_simi(const SP & sp_mat, int idx, int another_idx,
                                        double simi_th);

public:
    static IDX_SCORE_VEC naive_kNearest(const SP & sp_mat, int idx, int another_idx,
